...
Average-fill hard targets are accepted only in exact bounded cases.  If the
existing laboratory lower bounds already imply
\[
...
Other average-fill side constraints are global rational resource constraints;
the implementation rejects them rather than silently using a heuristic.
