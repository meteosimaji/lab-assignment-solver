...
Eighth, if all students have identical rank rows, the program uses a closed
...
polynomial-time optimizer for arbitrary assignment objectives.  Unrestricted
black-box or succinct nonlinear objectives may require exponential search or
can encode NP-hard variants.
